...
const OrdersAdminTable = lazy(() => import('./ShipmentsTable'));
                    ...
                    {props.tabItems.map((tabItem) => (
                        <Tab
                            ...
                            label={
                                <div>
                                    {tabItem.name}
                                    <span className="ml-9 text-white bg-blue-600 py-1 px-7">{t('SHIPMENTS_COUNT', {count: tabItem.shipments.length})}</span>
                                </div>
                            }
