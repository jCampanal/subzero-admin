...
function Shipments() {
  return (
    <div>
      <p className="h1">
        <i className="fa fa-truck-loading mr-4" />
        Shipments{' '}
        <span className="text-gray-50 rounded-full px-16 bg-blue-600">{dummyShipments.length}</span>
      </p>
      <div className="mt-14">
          ...
          <Accordion>
            ...
            >
              <Typography className="h3">
                {item.name}{' '}
                <span className="rounded-full px-9 py-3 bg-blue-600 text-gray-50 shadow-sm">
