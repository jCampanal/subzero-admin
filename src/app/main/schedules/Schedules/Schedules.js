...
const dummySchedules = [
    ...
    {id: 4, reference: 'Lorem', customer: 'Grep', company: 'Gue Ueg Egu Geu', nextOrder: 'Gue Ueg Egu Geu', paused: false},
    ...
    {id: 8, reference: 'Lorem', customer: 'Grep', company: 'Gue Ueg Egu Geu', nextOrder: 'Gue Ueg Egu Geu', paused: false},
...
function Schedules() {
    ...
    return (
        <div>
            <p className="h1">
                <ScheduleIcon className="text-5xl mr-14" />
                Schedules <span className="text-gray-50 rounded-full px-16 bg-blue-600">{schedules.length}</span>
            </p>
                                        ...
                                        <tr key={item.id} className="odd:bg-gray-200 hover:bg-gray-100">
                                            ...
                                            <td className="px-14 py-3">
                                                <div className="flex justify-end items-center">
                                                    ...
                                                    >
                                                        <i className={`fa ${item.paused ? 'fa-play-circle' : 'fa-pause-circle'} mr-4`} />
            ...
            <ConfirmDlg open={confirmDelete} handleClose={toggleConfirmation} confirm={deleteSchedule} subject={schedule} />
