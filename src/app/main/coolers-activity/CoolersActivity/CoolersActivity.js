...
function CoolersActivity() {
    ...
    return (
        <div>
            <p className="h1">
                <HistoryIcon className="text-5xl mr-14" />
                Coolers Activity <span className="text-gray-50 rounded-full px-16 bg-blue-600">{dummyCoolers.length}</span>
            </p>
