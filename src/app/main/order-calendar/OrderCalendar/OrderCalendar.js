    ...
    return (
        <div className="px-10 md:px-20">
            <p className="h2 sm:h1 mt-12">
                ...
                {t('ORDERS_CALENDAR')} <span className="text-gray-50 rounded-full px-16 bg-blue-600">{dummyOrders.length}</span>
            </p>
            <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg my-14">
                <FuseScrollbars className="flex-grow overflow-x-auto">
                    <Table className="min-w-xl" aria-labelledby="tableTitle">
                        <TableHead>
                            <TableRow className="h-48 sm:h-64">
                                ...
                                {dates.slice(0, 7).map((date) => (
                                    <TableCell padding="none" className="w-40 md:w-64 text-center">
                                        {`${t(Days[date.getDay()])} ${date.getDate()}/${date.getMonth() + 1}`}
                                    </TableCell>
                                ))}
                                <TableCell padding="none" className="w-40 md:w-64 text-center">
                                    {t('TOTAL')}
                        ...
                        <TableBody>
                            <TableRow className="h-72 cursor-pointer" hover tabIndex={-1}>
