...
const dummyCustomers = [
    {id: 1, email: 'gue@ipsum.com', firstName: 'Gue', lastName: 'Lorem', phone: '235324', company: 'Amet Dolor'},
    {id: 2, email: 'gue@ipsum.com', firstName: 'Gue', lastName: 'Lorem', phone: '235324', company: 'Amet Dolor'},
    {id: 3, email: 'gue@ipsum.com', firstName: 'Gue', lastName: 'Lorem', phone: '235324', company: 'Amet Dolor'},
    {id: 4, email: 'gue@ipsum.com', firstName: 'Gue', lastName: 'Lorem', phone: '235324', company: 'Amet Dolor'},
    {id: 5, email: 'gue@ipsum.com', firstName: 'Gue', lastName: 'Lorem', phone: '235324', company: 'Amet Dolor'},
    {id: 6, email: 'gue@ipsum.com', firstName: 'Gue', lastName: 'Lorem', phone: '235324', company: 'Amet Dolor'},
    {id: 7, email: 'gue@ipsum.com', firstName: 'Gue', lastName: 'Lorem', phone: '235324', company: 'Amet Dolor'},
    {id: 8, email: 'gue@ipsum.com', firstName: 'Gue', lastName: 'Lorem', phone: '235324', company: 'Amet Dolor'},
];
...
function Customers() {
    return (
        <div>
            <p className="h1">
                <PersonIcon className="text-5xl mr-14" />
                Costumers <span className="text-gray-50 rounded-full px-16 bg-blue-600">{dummyCustomers.length}</span>
            </p>
