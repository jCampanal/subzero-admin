    ...
    return (
        <div className="flex flex-1 w-full items-center justify-between">
            ...
            <motion.div className="flex" initial={{opacity: 0, x: 20}} animate={{opacity: 1, x: 0, transition: {delay: 0.3}}}>
                <IconButton className="sm:hidden" onClick={() => props.deleteCallback([props.product.id])}>
                    <DeleteIcon />
                </IconButton>
                <Button
                    ...
                    variant="contained"
                    color="secondary"
                    onClick={() => props.deleteCallback([props.product.id])}
                >
                    <DeleteIcon className="mr-5" />
                    {t('REMOVE')}
                </Button>

                <IconButton className="sm:hidden" onClick={() => history.push(`/products/${id}/edit`, {product: props.product})}>
                    <EditIcon />
                </IconButton>
                <Button
                    ...
                    variant="contained"
                    color="secondary"
                    onClick={() => history.push(`/products/${id}/edit`, {product: props.product})}
                >
