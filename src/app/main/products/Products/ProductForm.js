...
import {TextField, Dialog, DialogActions, DialogContent, DialogTitle, Select, MenuItem, FormControlLabel, Checkbox} from '@material-ui/core';
...
export default function ProductForm(props) {
    ...
    return (
        <Dialog open={props.open} onClose={props.handleClose} aria-labelledby="form-dialog-title">
            <DialogTitle id="form-dialog-title">{product.id === 0 ? 'Create product' : 'Edit product'}</DialogTitle>
            <DialogContent>
                <TextField
                    value={product.name}
                    autoFocus
                ...
                <FormControlLabel
                    control={
                        <Checkbox
                            ...
                            onChange={(e) => setProduct((prevState) => ({...prevState, visible: e.target.checked}))}
                        />
                    }
