...
import {deleteSaleUnit, getSaleUnits} from '../../../api-conn/products/sale-units';
    ...
    const onProceed = (itemsId) => {
        deleteSaleUnit(JSON.stringify(itemsId))
            ...
            .catch(() => {
                dispatch(
                    showMessage({
                        message: 'Error trying to delete sale unit. Please try again later.',
                        variant: 'error',
                    })
                );
            });
        ...
        <div className="flex flex-wrap justify-center sm:justify-start max-w-2xl">
            ...
            <FormControl error={!!errors.salesUnitsId} component="fieldset" variant="standard" className="mt-8 mb-16">
                <FormGroup>
                    ...
                    <Button className="mt-8 mb-16" onClick={() => riseSaleUnitForm()} variant="contained" color="secondary">
                        ...
                        {salesUnitsId.map((unit) => {
                            ...
                            return (
                                <React.Fragment key={unit.id}>
                                    ...
                                    />
                                    <IconButton className="col-start-11" onClick={() => riseSaleUnitForm(unit)}>
                                        <EditIcon />
                                    </IconButton>
                                    <IconButton className="col-start-12" onClick={() => removeSaleUnit([unit.id])}>
                                        <DeleteIcon />
                                    </IconButton>
                                </React.Fragment>
                            );
