...
function Coolers() {
    ...
    return (
        <div>
            <p className="h1">
                <i className="fa fa-box text-4xl mr-14" />
                Coolers <span className="text-gray-50 rounded-full px-16 bg-blue-600">{coolers.length}</span>
            </p>
            <div className="flex justify-center items-center min-w-full mb-10 gap-7">
                ...
                <Button href="#" className="text-blue-600 hover:text-blue-800 hover:no-underline" role="button">
                    Providers
                </Button>
                <Button href="#" className="text-blue-600 hover:text-blue-800 hover:no-underline" role="button">
                    Clients
            ...
            <ConfirmDlg open={confirmDelete} handleClose={toggleConfirmation} confirm={deleteCooler} subject={cooler} />
        </div>
    );
}
