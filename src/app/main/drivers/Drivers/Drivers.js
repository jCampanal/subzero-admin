...
function Drivers() {
  return (
    <div>
      <p className="h1">
        <i className="fa fa-truck mr-4" />
        Drivers{' '}
        <span className="text-gray-50 rounded-full px-16 bg-blue-600">{dummyDrivers.length}</span>
      </p>
                    ...
                    <tr key={index} className="odd:bg-gray-200 hover:bg-gray-100">
                      ...
                      <td className="px-14 py-3">
                        <div className="flex justify-end items-center">
                          ...
                          <Button
                            type="button"
                            className="text-sm text-green-700 hover:text-green-800 leading-none rounded-md mr-5"
                          >
